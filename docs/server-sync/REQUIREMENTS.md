...
- 개정일: 2026-09-21. 사용자 최종 결정 반영, Phase 4 mutation과 Phase 5.1~5.11의 SSR·cache/view·UI view·자동 재조회·pagination/infinite·query network mode·브라우저 adapter·clean/로컬 기준 영속화·독립 명령 queue·단일 연결 제출 기록 하위 범위까지 자동 검증. 전체 서버 기능 동등성은 미완료.
