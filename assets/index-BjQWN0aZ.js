(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))c(a);new MutationObserver(a=>{for(const l of a)if(l.type==="childList")for(const i of l.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&c(i)}).observe(document,{childList:!0,subtree:!0});function o(a){const l={};return a.integrity&&(l.integrity=a.integrity),a.referrerPolicy&&(l.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?l.credentials="include":a.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function c(a){if(a.ep)return;a.ep=!0;const l=o(a);fetch(a.href,l)}})();const ve=Symbol.for("lithentWDomSymbol"),be={value:""},de={value:null},ae={value:!1},V=new WeakMap,Lt=new WeakSet,Mr=t=>{V.set(t,{vd:{value:null},up:()=>{},upR:[],upS:{value:0},upD:[],upCB:[],mts:[],umts:[],wdCB:[]})},Pe=()=>de.value,vt=(t,r)=>{const o=V.get(t);return o?o[r]:null},Pr=t=>{de.value=t},_r=t=>{de.value=t,Mr(t)},Lr=t=>{const r=V.get(t);r&&(r.umts.forEach(o=>o()),r.umts=[])},Q=t=>t.getParent&&t.getParent(),Se=Object.entries,Ot=Object.keys,ke=t=>typeof t=="object"&&t!==null,_e=Object.assign,he=t=>ke(t)&&!("resolve"in t),We=(t,r)=>he(t)&&t.type===r,Or=(t,r)=>"ctor"in t?t.ctor===(r&&r.ctor):t===(r&&r.ctor),Fr=(t,r)=>!!(he(t)&&r&&r.type==="f"&&r.children&&r.children.length===(t.children&&t.children.length)),Ur=(t,r)=>!!(he(t)&&r&&r.type==="e"&&r.tag===t.tag&&r.children&&r.children.length===(t.children&&t.children.length)),yt=(t,r)=>!!(he(t)&&r&&r.type===t.type),Dr=(t,r)=>!!(he(t)&&r&&r.type===t.type&&(le((t.children||[])[0])&&le((r.children||[])[0])||r.children&&t.children&&r.children.length===t.children.length)),q=t=>(t&&t.compProps&&t.compProps.key)??(t&&t.props&&t.props.key),ie=t=>t&&["f","l"].includes(t),Le=t=>typeof t=="function"&&!Ft(t)||ke(t)&&"resolve"in t,Ft=t=>typeof t=="function"&&t===Be,Vr=t=>he(t)&&!t.type,le=t=>Ut(q(t)),Ut=t=>t!=null,St=(t,r)=>t==="style"&&ke(r),Br=(t,r)=>t==="ref"&&ke(r),$r=(t,r)=>{const o=Object.getOwnPropertyDescriptor(t.constructor.prototype,r);return o&&o.get&&o.set},jr=t=>Le(t)?"c":We(t,"f")?"f":We(t,"e")?"e":We(t,"l")?"l":We(t,"t")?"t":"et",Jr={c:Or,l:Dr,t:yt,e:Ur,f:Fr,et:yt},Dt=t=>{const r=Pe();if(r){const o=V.get(r);o&&o.umts.push(t)}},Oe=t=>{const{compKey:r}=t;r&&Kr(r),Vt(t)},Vt=t=>{(t.children||[]).forEach(r=>{r.compKey?Oe(r):Vt(r)})},Kr=t=>{Lr(t),V.delete(t)};let Ye=[];const zr=t=>{t.compKey&&Ye.push(t)},Ae=()=>{Ye.forEach(t=>Gr(t)),Ye=[]},Hr=t=>{const r=Pe();if(r){const o=V.get(r);o&&o.mts.push(t)}},Gr=t=>{const{compKey:r}=t;if(r){const o=V.get(r);if(!o)return;const{mts:c,upS:a}=o;de.value=r,a&&(a.value=0),c&&(o.mts=[],c.forEach(l=>{const i=l();i&&Dt(i)}))}},qr=t=>{const{compKey:r}=t;if(r){const o=V.get(r),c=o&&o.wdCB;de.value=r,c&&c.length>0&&(o.wdCB=[],c.forEach(a=>{const l=a();l&&typeof l=="function"&&Dt(l)}))}},Zr=t=>{const{compKey:r}=t;if(r){const o=V.get(r);if(!o)return;const{upCB:c,upS:a}=o;de.value=r,a&&(a.value=0),t.ctor&&c&&(o.upCB=[],c.forEach(l=>l()))}},Ee=()=>new DocumentFragment,Yr=t=>document.createElement(t),Xr=(t,r,o,c)=>{t.isRoot=!0,r=r||document.body,t.we=r;const a=Ue(t,c);return r.tagName==="HTML"?r.replaceWith(a):r.appendChild(a),Ae(),()=>{const l=V.get(t.compProps||{}),i=l&&l.vd.value||t;i!==t&&Oe(i),Fe(i),Qr(i)}},Fe=t=>{t.props&&t.el&&Jt(t.props,t.el),(t.children||[]).forEach(r=>{Fe(r)})},Qr=t=>Bt(t,t.we),ct=t=>{t.op&&t.el&&Jt(t.op,t.el);const r=Q(t),o=t.isRoot?t.we:r?De(r):void 0;o&&Bt(t,o)},Bt=(t,r)=>{r&&t.el&&(t.el.nodeType===11||(t==null?void 0:t.tag)==="portal"?$t(t):[1,3].includes(t.el.nodeType)&&r.removeChild(t.el),delete t.el)},$t=(t,r)=>{(t&&t.oc||t&&t.children||[]).forEach(o=>{const c=o.el&&o.el.nodeType;if(c)if([1,3].includes(c)){const a=o.el;a.tagName==="HTML"?a.innerHTML="":a.remove()}else c===11&&$t(o)})},Xe=t=>{ct(t),Ne(t)},en=t=>{tt(t);const r=Q(t);if(!r){if(t.isRoot){const o=Qe(t);Ne(t,o)}return}if(r.nr!=="L"){const o=Qe(t);Ne(t,o)}},Ne=(t,r)=>{r||(r=Ue(t));const o=Q(t);if(!o||!o.type){t.isRoot&&t.we&&r&&t.tag!=="portal"&&(t.ae?t.we.insertBefore(r,t.ae):t.we.tagName==="HTML"?t.we.replaceWith(r):t.we.appendChild(r),Ae());return}const c=De(o),a=o.type==="l"&&o.nr&&o.nr!=="L"?et(o,Q(o)):et(t,o);r&&c&&(t.tag!=="portal"&&(a?c.insertBefore(r,a):c.appendChild(r)),Ae())},Qe=t=>ie(t.type)?(t&&t.children||[]).reduce((r,o)=>{const c=Qe(o);return c&&r.appendChild(c),r},Ee()):t.el,et=(t,r)=>{const o=r.children||[],c=o.indexOf(t)+1,a=o.slice(c),l=jt(a),i=r.type||"";if(l)return l;if(!r.isRoot&&ie(i))return et(r,Q(r));if(r.isRoot&&ie(i)&&r.ae)return r.ae},jt=t=>t.reduce((r,o)=>{if(r)return r;const{type:c,el:a}=o;if(c&&ie(c)){const l=jt(o.children||[]);if(l)return l}return a&&a.nodeType!==11?a:r},void 0),tn=t=>{const r=Q(t),o=t.el;if(t.isRoot&&!r&&o){Xe(t);return}if(r&&r.type&&o)if(o.nodeType===11)Xe(t);else{const c=De(r),a=Ue(t);c&&t.tag!=="portal"&&c.replaceChild(a,o),Ae()}},Jt=(t,r)=>{Se(t||{}).forEach(([o,c])=>{o.match(/^on/)&&r.removeEventListener(o.slice(2).toLowerCase(),c)})},tt=t=>{if(t.type==="t"){nn(t);return}if(t.el){const{op:r,props:o}=t;zt(o,t.el,r),delete t.op,t.tag==="input"&&(t.el.value=String(o&&o.value||""))}(t.children||[]).forEach(r=>Kt(r)),Zr(t)},Kt=t=>{const{nr:r}=t;r!==void 0&&r!=="N"&&(rn[r](t),delete t.nr,delete t.oc,delete t.op)},rn={A:Ne,D:ct,R:tn,U:tt,S:Xe,T:en,L:tt},nn=t=>{t.el&&(t.el.nodeValue=String(t.text))},zt=(t,r,o,c)=>{const a=o||{};Se(t||{}).forEach(([l,i])=>{if(i===a[l]){delete a[l];return}l==="key"||i===a[l]||l==="portal"&&ke(i)||(l==="innerHTML"&&typeof i=="string"?r.innerHTML=i:St(l,i)?ln(i,St(l,a.style)?a.style:{},r):Br(l,i)?i.value=r:l.match(/^on/)?an(r,l,i,a[l]):l&&(l!=="type"&&$r(r,l)?r[l]=i:on(l==="className"?"class":l,r,i))),delete a[l]}),Ot(a).forEach(l=>r.removeAttribute(l))},on=(t,r,o)=>be.value&&t!=="xmlns"?r.setAttributeNS(null,t,o):r.setAttribute(t,o),Ue=(t,r)=>{let o;const{type:c,tag:a,text:l,props:i,children:s=[]}=t,d=ie(c);if(qr(t),a==="svg"&&(be.value=String(i&&i.xmlns)),!r){if(!c)o=Ee();else if(d)o=Ee();else if(c==="e"&&a)a==="portal"&&i&&i.portal?o=i.portal:o=be.value?document.createElementNS(be.value,a):Yr(a);else if(c==="t"&&Ut(l))o=document.createTextNode(String(l));else throw Error("Invalid wDom");t.el=o}return cn(s,o,r),zt(i,o,null),zr(t),a==="svg"&&(be.value=""),o},cn=(t,r,o)=>{const c=t.reduce((a,l)=>{if(l.type){const i=Ue(l,o);l.tag!=="portal"&&!o&&a.appendChild(i)}return a},Ee());r&&c.hasChildNodes()&&r.appendChild(c)},an=(t,r,o,c)=>{const a=r.slice(2).toLowerCase();c!==o&&(c&&t.removeEventListener(a,c),o&&t.addEventListener(a,o))},ln=(t,r,o)=>{const c={...r},a=o instanceof HTMLElement?o:null,l=a==null?void 0:a.style;if(!l)return;const i=l;Se(t).forEach(([s,d])=>{i[s]=d,delete c[s]}),Se(c).forEach(([s])=>{i[s]=""})},De=t=>{const r=ie(t.type);return t.isRoot&&r?t.we:r?De(Q(t)):t.el},Ve=(t,r)=>sn(t,Jr[jr(t)](t,r),r),sn=(t,r,o)=>{const c=mn(t,r,o),a=hn(c,r,o),l=a==="N";return l||(c.children=bn(c,r,o)),c.nr=a,dn(c,o,a),!l&&o&&(o.il=!0,delete o.children),(o==null?void 0:o.tag)==="portal"&&(c.tag="portal"),c},dn=(t,r,o)=>{o!=="A"&&r&&(t.el=r.el),(o==="D"||o==="R"||o==="S")&&(r&&(Oe(r),Fe(r)),t.oc=r&&r.children),t.op=r&&r.props},hn=(t,r,o)=>{if(Vr(t))return"D";if(t.type==="t"&&r&&t.text===(o&&o.text)||t===o)return"N";if(!(o&&o.type))return"A";const c=Q(o),a=!t.isRoot&&c&&c.type==="l"&&le(t);let l=r?a?"T":"U":a?"S":"R";return t.type==="l"&&l==="U"&&o&&un(t,o)&&(l="L"),l},un=(t,r)=>{if(!le((t.children||[])[0])||!le((r.children||[])[0]))return!1;const o=[...r&&r.children||[]],c=[...t&&t.children||[]].filter(i=>o.find(s=>q(i)===q(s))),a=o.filter(i=>c.find(s=>q(i)===q(s)));let l=a.length===c.length;return l&&(l=a.every((i,s)=>q(i)===q(c[s]))),l},pn=(t,r)=>{t&&r!==t&&(Ot(t).forEach(o=>delete t[o]),Se(r||{}).forEach(([o,c])=>t[o]=c))},gn=(t,r)=>{t&&(t.splice(0,t.length),r&&r.forEach(o=>t.push(o)))},fn=(t,r)=>{const{compProps:o,compChild:c}=t,{props:a,children:l}=r;return o&&pn(o,a),c&&l&&c!==l&&gn(c,l),t.reRender&&t.reRender()},mn=(t,r,o)=>Le(t)?r&&o?fn(o,t):t.resolve():t,bn=(t,r,o)=>r&&o?yn(t,o):vn(t),vn=t=>(t.children||[]).map(r=>_e(Ve(r),{getParent:()=>t})),yn=(t,r)=>t.type==="l"&&le((t.children||[])[0])?Sn(t,r):(t.children||[]).map((o,c)=>_e(Ve(o,(r.children||[])[c]),{getParent:()=>t})),Sn=(t,r)=>{const[o,c]=wn(t,r);return c.forEach(a=>{Oe(a),Fe(a),ct(a)}),o},wn=(t,r)=>{const o=[...r.children||[]];return[(t.children||[]).map(c=>{const a=Rn(c,o),l=Ve(c,a);return a&&o.splice(o.indexOf(a),1),l.getParent=()=>t,l}),o]},Rn=(t,r)=>r.find(o=>q(o)===q(t)),rt=new Map;let nt=!1;const kn=(t,r)=>{const o=V.get(t);o&&(o.up=()=>{rt.set(t,r),nt||(nt=!0,queueMicrotask(xn))})},Ht=t=>()=>{const r=V.get(t),o=r&&r.up;return o?(o(),!0):!1},xn=()=>{rt.forEach(t=>{t()}),rt.clear(),nt=!1},Cn=()=>{const t=Pe();if(!t)return;const r=V.get(t),o=r&&r.upR;o&&o.length&&o.forEach(c=>c())},Be=(t,...r)=>({type:"f",[ve]:!0,children:r}),wt=(t,r,...o)=>{const c={value:void 0},a=Gt(c,o),l=En(t,r||{},a);return Le(l)||(c.value=l),l},m=t=>(r,o)=>t,Wn=t=>(r,o)=>(Lt.add(t),t),Tn=(t,r,o)=>{const c=(a,l)=>{if(!(!a||l.has(a))){if(l.add(a),a.compChild){const i=a.compChild.indexOf(r);i!==-1&&a.compChild.splice(i,1,o)}c(a.getParent?a.getParent():void 0,l)}};c(t,new Set)},An=(t,r,o,c)=>{if(c.il)return;ae.value=!0;const a=Zt(t,r,o),l=Ve(a,c),{isRoot:i,getParent:s,we:d,ae:b}=c;if(l.getParent=s,!i&&s){const S=s(),k=S&&S.children||[],R=k.indexOf(c);R!==-1&&k.splice(R,1,l),Tn(S,c,l)}else l.isRoot=!0,l.we=d,l.ae=b;ae.value=!1,Kt(l)},En=(t,r,o)=>{if(Ft(t))return Be(r,...o);if(Le(t)){const c=Zt(t,r,o);return ae.value?c:c.resolve()}return{type:"e",[ve]:!0,tag:t,props:r,children:o}},Gt=(t,r)=>r.map(o=>_e(qt(o),{getParent:()=>t.value})),qt=t=>{if(t==null||t===!1)return{type:null,[ve]:!0};if(Array.isArray(t)){const r={value:void 0},o=Gt(r,t),c={type:"l",[ve]:!0,children:o};return r.value=c,c}else if(typeof t=="string"||typeof t=="number")return{type:"t",[ve]:!0,text:t};return t},Nn=(t,r,o)=>(c=r)=>{const a=ae.value;ae.value=!1,_r(c);const l=t(r,o);let i;if(typeof l=="function"){const d=l;i=Lt.has(d)?d(r,o):d(Ht(c),r,o)}else i=d=>t(d,o);const s=In(i,c,t,r,o);return ae.value=a,s},Zt=(t,r,o)=>{const c=t,a=o,l=Nn(t,r,a);return{ctor:c,props:r,children:a,resolve:l}},In=(t,r,o,c,a)=>{const l=b=>qt(t(b)),{wrappedComponentMaker:i,customNode:s}=_n(l,c),d=Mn(i,r,o,c,a);return Yt(s,r,o,c,a,d),s},Mn=(t,r,o,c,a)=>{const l=()=>Pn(t,r,o,c,a,l);return l},Pn=(t,r,o,c,a,l)=>{Pr(r),Cn();const i=t(c);return Yt(i,r,o,c,a,l),i},_n=(t,r)=>{const o=a=>{const l=t(a),i=Be({},l);return l.getParent=()=>i,i},c=o(r);return{wrappedComponentMaker:o,customNode:c}},Yt=(t,r,o,c,a,l)=>{_e(t,{compProps:c,compChild:a,ctor:o,compKey:r,reRender:l}),kn(r,()=>An(o,t.compProps||c,t.compChild||a,t)),vt(r,"vd")&&(vt(r,"vd").value=t)},Ln=t=>({value:t}),On=()=>{const t=Pe();return t?Ht(t):()=>!1};function e(t,r,o,c,a,l){const{children:i,...s}=r;if(i!=null){const d=Array.isArray(i)?i:[i];return wt(t,{...s,key:o},...d)}return wt(t,{...s,key:o})}const Fn={cache:!0};function Un(t){const r={value:!1},o=!Array.isArray(t)&&typeof t=="object"&&t!==null?t:{value:t},c=new Set,a=[],l=new WeakMap,i=(s,d,b)=>{const{cache:S}=Object.assign({},Fn,b||{});if(S&&s&&l.has(s))return l.get(s);const k={},R=new Set;let W={value:null},E=()=>{};return a.push(k),s&&d&&(E=()=>s(W.value),W.value=Rt(o,r,c,R,a,E,k),r.value=!0,d(W.value),r.value=!1),W.value||(W.value=Rt(o,r,c,R,a),s&&(E=()=>s(W.value),c.add(E))),s&&(Vn(E,c,k,R),l.set(s,W.value)),W.value};return{useStore(s,d){const b=On();return i(b,s,d)},watch(s,d,b){return i(s,d,b)}}}function Rt(t,r,o,c,a,l,i){return new Proxy(t,{get(s,d){return l&&i&&r.value&&(i[d]??(i[d]=new Set),i[d].has(l)||(i[d].add(l),c.add(d))),s[d]},set(s,d,b){return s[d]===b||(s[d]=b,Dn(o,a,d)),!0}})}function Dn(t,r=[],o){const c=new Set;xt(t).forEach(a=>c.add(a)),(r||[]).forEach(a=>{const l=a[o]||new Set;xt(l).forEach(i=>c.add(i)),kt(c,l)}),kt(c,t)}function kt(t,r){t.forEach(o=>{r.delete(o)})}function xt(t){const r=[];return t.forEach(o=>{o()===!1&&r.push(o)}),r}function Vn(t,r,o,c){const a=t();a instanceof AbortSignal&&a.addEventListener("abort",()=>{const l=o||{};r.delete(t),Object.entries(l).forEach(([i,s])=>{s.delete(t),c.delete(i)})})}const Xt="/ko",Bn=t=>t.startsWith("/")?t:`/${t}`,$n=t=>Bn(t||"/").replace(/^\/ko(?=\/|$)/,"")||"/",Qt=()=>location.hash.slice(1)||"/",ye=(t,r)=>{const o=$n(t);return r==="ko"?`${Xt}${o}`:o},jn=()=>{const t=localStorage.getItem("stateref-theme");return t==="light"||t==="dark"?t:window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light"},$e=Un({theme:jn(),route:Qt(),sidebarOpen:!1}),Z=$e.watch(),er=t=>{Z.theme=t,localStorage.setItem("stateref-theme",t),t==="dark"?document.documentElement.classList.add("dark"):document.documentElement.classList.remove("dark")},Jn=()=>{er(Z.theme==="light"?"dark":"light")},at=()=>Z.route.startsWith(Xt),tr=t=>{Z.route=t,location.hash=`#${t}`,Z.sidebarOpen=!1,window.scrollTo(0,0)},je=t=>{const r=at()?"ko":"en",o=ye(t,r);tr(o)},Kn=t=>{const r=ye(Z.route,t);r!==Z.route&&tr(r)},zn=()=>{Kn(at()?"en":"ko")};window.addEventListener("hashchange",()=>{Z.route=Qt(),window.scrollTo(0,0)});er(Z.theme);const Hn=m(t=>{const r=$e.watch(t);return()=>e("header",{class:"sticky top-0 z-50 bg-white dark:bg-[#1b1b1f] border-b border-gray-200 dark:border-gray-800",children:e("div",{class:"mx-auto max-w-[1440px] px-6 md:px-12",children:e("div",{class:"flex items-center justify-between h-16",children:[e("div",{class:"flex items-center",children:e("a",{href:"#/",onClick:o=>{o.preventDefault(),je("/")},class:"flex items-center gap-3 hover:opacity-80 transition-opacity",children:[e("img",{src:"/state-ref/stateref.png",alt:"StateRef Logo",class:"w-8 h-8 rounded-lg"}),e("span",{class:"text-xl font-bold text-gray-900 dark:text-white",children:"StateRef"})]})}),e("div",{class:"flex items-center gap-2",children:[e("button",{onClick:zn,class:"px-3 py-1.5 rounded-md text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors",children:at()?"KO":"EN"}),e("button",{onClick:Jn,class:"p-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors","aria-label":"Toggle theme",children:r.theme==="light"?e("svg",{xmlns:"http://www.w3.org/2000/svg",class:"w-5 h-5 text-gray-700 dark:text-gray-300",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z"})}):e("svg",{xmlns:"http://www.w3.org/2000/svg",class:"w-5 h-5 text-gray-700 dark:text-gray-300",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z"})})}),e("a",{href:"https://github.com/superlucky84/state-ref",target:"_blank",rel:"noopener noreferrer",class:"p-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors","aria-label":"GitHub",children:e("svg",{xmlns:"http://www.w3.org/2000/svg",class:"w-5 h-5 text-gray-700 dark:text-gray-300",fill:"currentColor",viewBox:"0 0 24 24",children:e("path",{"fill-rule":"evenodd",d:"M12 2C6.477 2 2 6.484 2 12.017c0 4.425 2.865 8.18 6.839 9.504.5.092.682-.217.682-.483 0-.237-.008-.868-.013-1.703-2.782.605-3.369-1.343-3.369-1.343-.454-1.158-1.11-1.466-1.11-1.466-.908-.62.069-.608.069-.608 1.003.07 1.531 1.032 1.531 1.032.892 1.53 2.341 1.088 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.113-4.555-4.951 0-1.093.39-1.988 1.029-2.688-.103-.253-.446-1.272.098-2.65 0 0 .84-.27 2.75 1.026A9.564 9.564 0 0112 6.844c.85.004 1.705.115 2.504.337 1.909-1.296 2.747-1.027 2.747-1.027.546 1.379.202 2.398.1 2.651.64.7 1.028 1.595 1.028 2.688 0 3.848-2.339 4.695-4.566 4.943.359.309.678.92.678 1.855 0 1.338-.012 2.419-.012 2.747 0 .268.18.58.688.482A10.019 10.019 0 0022 12.017C22 6.484 17.522 2 12 2z","clip-rule":"evenodd"})})}),e("button",{class:"lg:hidden p-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-800",onClick:()=>{r.sidebarOpen=!r.sidebarOpen},children:e("svg",{xmlns:"http://www.w3.org/2000/svg",class:"w-6 h-6 text-gray-700 dark:text-gray-300",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M4 6h16M4 12h16M4 18h16"})})})]})]})})})}),Ge=[{text:{en:"Getting Started",ko:"시작하기"},items:[{text:{en:"Introduction",ko:"소개"},link:"/guide/introduction"},{text:{en:"Quick Start",ko:"빠른 시작"},link:"/guide/quick-start"}]},{text:{en:"Core Concepts",ko:"핵심 개념"},items:[{text:{en:"createStore",ko:"createStore"},link:"/guide/create-store"},{text:{en:"Watch Function",ko:"Watch 함수"},link:"/guide/watch"},{text:{en:"Understanding References",ko:"참조 이해하기"},link:"/guide/references"},{text:{en:"StateRefStore",ko:"StateRefStore"},link:"/guide/state-ref-store"},{text:{en:"Subscription",ko:"구독"},link:"/guide/subscription"},{text:{en:"Primitive Types",ko:"원시 타입"},link:"/guide/primitives"}]},{text:{en:"Advanced Usage",ko:"고급 사용법"},items:[{text:{en:"createComputed",ko:"createComputed"},link:"/guide/computed"},{text:{en:"combineWatch",ko:"combineWatch"},link:"/guide/combine-watch"},{text:{en:"Manual Sync (Flux)",ko:"수동 동기화 (Flux)"},link:"/guide/manual-sync"}]},{text:{en:"Helper Functions",ko:"헬퍼 함수"},items:[{text:{en:"Lens Pattern",ko:"Lens 패턴"},link:"/guide/lens"},{text:{en:"copyable",ko:"copyable"},link:"/guide/copyable"},{text:{en:"cloneDeep",ko:"cloneDeep"},link:"/guide/clone-deep"}]},{text:{en:"Framework Integration",ko:"프레임워크 연동"},items:[{text:{en:"React",ko:"React"},link:"/guide/react"},{text:{en:"Preact",ko:"Preact"},link:"/guide/preact"},{text:{en:"Vue",ko:"Vue"},link:"/guide/vue"},{text:{en:"Svelte",ko:"Svelte"},link:"/guide/svelte"},{text:{en:"Solid",ko:"Solid"},link:"/guide/solid"},{text:{en:"Lithent",ko:"Lithent"},link:"/guide/lithent"},{text:{en:"Custom Connector",ko:"커스텀 커넥터"},link:"/guide/custom-connector"}]},{text:{en:"API Reference",ko:"API 레퍼런스"},items:[{text:{en:"Core API",ko:"코어 API"},link:"/api/core"},{text:{en:"Helper API",ko:"헬퍼 API"},link:"/api/helpers"},{text:{en:"TypeScript Types",ko:"TypeScript 타입"},link:"/api/types"}]}],qe=t=>t.replace(/\/+$/,"")||"/",Gn=m(t=>{const r=$e.watch(t),o=Object.fromEntries(Ge.map(i=>[i.text.en,!1]));let c="";const a=i=>{const s=r.route.startsWith("/ko")?"ko":"en";je(ye(i,s))},l=i=>{o[i]=!o[i],t()};return()=>{const i=r.route!==c,s=qe(r.route),d=r.route.startsWith("/ko")?"ko":"en",b=k=>qe(ye(k,d));i&&(s==="/"||s==="/ko")&&Ge.forEach(k=>{o[k.text.en]=!1});const S=e(Be,{children:[r.sidebarOpen&&e("div",{class:"fixed inset-0 bg-black bg-opacity-50 z-30 lg:hidden",onClick:()=>{r.sidebarOpen=!1}}),e("aside",{class:`
          ...
          `,children:e("nav",{class:"pl-6 md:pl-12 pr-3 md:pr-4 py-6",children:Ge.map(k=>{const R=k.text.en;i&&s!=="/"&&s!=="/ko"&&k.items.some(A=>b(A.link)===s)&&(o[R]=!0);const W=o[R];return e("div",{class:"mb-3",children:[e("button",{class:"mb-1 w-full flex items-center justify-between text-sm font-semibold text-gray-900 dark:text-white uppercase tracking-wider",onClick:()=>l(R),children:[e("span",{children:k.text[d]}),e("span",{class:"text-base leading-none",children:W?"▾":"▸"})]}),e("ul",{class:`
                    ...
                    `,"aria-hidden":!W,children:k.items.map(E=>{const A=ye(E.link,d),O=s===qe(A);return e("li",{children:e("a",{href:A,onClick:H=>{H.preventDefault(),a(E.link)},class:`
